...
<html>
    <head>
        ...
        <title>Supprimer universitaire</title>
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
    </head>
    <body style="background-image: url('nature.PNG');background-repeat: no-repeat;background-size: 100% 100%;background-attachment: fixed;">
    ...
    <div align="center">
        ...
        <div class="input-group" style="width:50%" align="center">
            ...
            <div class="input-group-append">
                <button class="btn btn-outline-secondary" type="submit" id="button-addon2" name="SuppFormUniv">Chercher</button>
            </div>
        </div>
        </form>
    </div>
    ...
    <table class="table table-striped table-dark" style="width:50%" align="center">
        ...
        <tbody>
            ...
            <td>
                <form action="${pageContext.request.contextPath}/UnivServlet" method="POST" >
                    <input  name="IdDelUniv" type="hidden" value="${UnivSearch[i-1]}">
                    
                    <input type="submit" class="btn btn-outline-danger" value="Supprimer" name="DelFormUniv">
                </form>
            </td>
            </tr>
            </c:forEach>
