...
<html>
    <head>
        ...
        <title>Ajouter fonctionnaire</title>
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    </head>
    <body style="background-image: url('road.jpg');background-repeat: no-repeat;background-size: 100% 100%;background-attachment: fixed;">
    ...
    <div style="padding-left:450px;">
        <form action="${pageContext.request.contextPath}/FoncServlet" method="POST" >
            <div  style="width: 600px; text-align:center;" >
                ...
                <div style="padding:10px;">
                   <input name="fonction" class="form-control" placeholder="Fonction"/>
                </div>
                
                
                <div style="padding:20px;text-align:center">
                    <input type="submit" value="Submit" class="btn btn-primary"  name="AjoutFormFonc" />
                </div>
            </div>
        </form>
    </div>
