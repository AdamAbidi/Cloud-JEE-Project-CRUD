...
<html>
    ...
    <body style="background-color:#d6a1b3">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="SuppEtudJSP.jsp">Supprimer</a>
                </li>
    ...
    <div align="center">
        ...
        <div class="input-group" style="width:50%" align="center">
            ...
            <div class="input-group-append">
                <button class="btn btn-outline-secondary" type="submit" id="button-addon2" name="ModifForm">Chercher</button>
            </div>
        </div>
        </form>
    </div>
    ...
    <table class="table table-striped table-dark" style="width:50%" align="center">
        ...
        <tbody>
            ...
            <td>${resultat[i+3]}</td>
            <td>${resultat[i+4]} %</td>
            <td><a href="ModifForm.jsp?id=${resultat[i-1]}&nom=${resultat[i]}&prenom=${resultat[i+1]}&classe=${resultat[i+2]}&moy=${resultat[i+3]}&abs=${resultat[i+4]}">Modifier</a></td>
            </tr>
            </c:forEach>
