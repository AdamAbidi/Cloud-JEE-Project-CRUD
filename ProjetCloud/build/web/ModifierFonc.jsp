...
<html>
    <head>
        ...
        <title>Modifier fonctionnaires</title>
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
    </head>
    <body  style="background-image: url('modifFonc.jpg');background-repeat: no-repeat;background-size: 100% 100%;background-attachment: fixed;">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="SuppFonc.jsp">Supprimer</a>
                </li>
    ...
    <div align="center">
        ...
        <div class="input-group" style="width:50%" align="center">
            ...
            <div class="input-group-append">
                <button class="btn btn-outline-secondary" type="submit" id="button-addon2" name="ModifFormFonc">Chercher</button>
            </div>
        </div>
        </form>
    </div>
    ...
    <table class="table table-striped table-dark" style="width:50%" align="center">
        ...
        <tbody>
            ...
            <td><a href="ModifierFormFonc.jsp?id=${FoncSearch[i-1]}&nom=${FoncSearch[i]}&prenom=${FoncSearch[i+1]}&fonction=${FoncSearch[i+2]}">Modifier</a></td>
            </tr>
            </c:forEach>
