        ...
        <div style="padding-left:450px;">
            <form action="${pageContext.request.contextPath}/UnivServlet" method="POST" >
                <div  style="width: 600px; text-align:center;" ><h6><font color="white">Nom :</font> </h6>
                    ...
                    <div style="padding:10px;"><h6><font color="white">Grade :</font> </h6>
                        <input name="grade" class="form-control" value="${grade}" placeholder="grade"/>
                    </div>
                    ...
                    <div style="padding:20px;text-align:center">
                        <input type="submit" value="submit" class="btn btn-primary"  name="UpdateFormUniv" />
                    </div>
                </div>
            </form>
        </div>
